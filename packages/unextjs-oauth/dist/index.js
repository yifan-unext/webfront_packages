...
var transformRequest = function (jsonData) {
    ...
    return Object.entries(jsonData)
        .map(function (x) { return encodeURIComponent(x[0]) + "=" + encodeURIComponent(x[1]); })
        .join('&');
};
...
exports.migrateTokens = function (ctx, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var isProd, cookies, securityToken, accessToken, response, data, headers, exchange, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios_1.default.post('/oauth2/migration', {
                            client_id: 'unextApp',
                            scope: ['offline'],
                            portal_user_info: {
                ...
                case 2:
                    response = _a.sent();
                    if (!(response.data && response.data.auth_code)) return [3 /*break*/, 4];
                    data = {
                    ...
                    return [4 /*yield*/, axios_1.default.post('/oauth2/token', transformRequest(data), { headers: headers })];
                case 3:
                    exchange = _a.sent();
